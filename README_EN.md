...
the bundled 0.3.7 wheel to create a private user environment and managed launcher,
...
older configuration and Skill to 0.3.7. After a successful transactional upgrade,
