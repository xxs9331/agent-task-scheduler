...
the bundled 0.4.2 wheel to create a private user environment and managed launcher,
...
older configuration and Skill to 0.4.2. After a successful transactional upgrade,
